...
/*----------------------------------------*/
	...
	if ($('.countdown').elExists()) {
	 ...
	 // Lấy đối tượng div countdown
	 var countdownDiv = document.querySelector('[countdown]');

	 // Lấy thời gian mục tiêu từ thuộc tính data-date
	 var targetDate = new Date(countdownDiv.getAttribute('data-date')).getTime();
	 ...
	 var countdownInterval = setInterval(function() {
	   ...
	   countdownDiv.querySelector('[data-days]').textContent = days;
	   countdownDiv.querySelector('[data-hours]').textContent = hours;
	   countdownDiv.querySelector('[data-minutes]').textContent = minutes;
	   countdownDiv.querySelector('[data-seconds]').textContent = seconds;
   
	   // Kiểm tra xem thời gian đã hết chưa
	   if (timeRemaining <= 0) {
		 clearInterval(countdownInterval);
		 countdownDiv.innerHTML = "Đã qua thời gian mục tiêu";
	   }
	 }, 1000);
	/*------------------------------------
	    Magnific Popup
